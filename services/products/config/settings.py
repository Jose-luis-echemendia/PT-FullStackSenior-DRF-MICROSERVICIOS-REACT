"""Django settings for the Products microservice."""
...
SECRET_KEY = config("DJANGO_SECRET_KEY", default="dev-insecure-products-key")
...
# Defaults to SQLite for local/test runs; DATABASE_URL (Postgres) in Docker.
DATABASES = {
